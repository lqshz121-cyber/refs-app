...
const scope={tenantId:'11111111-1111-4111-8111-111111111111',entityId:'22222222-2222-4222-8222-222222222222',actors:Object.fromEntries(['reader','maker','submitter','reviewer','approver','poster','reconciliationStarter','clearer','reopener'].map(role=>[role,`internal-${role}`]))};
test('internal full-test grant reconciliation provisions distinct workflow actors',async()=>{
  ...
  assert.equal(calls.find(call=>call.actorId===scope.actors.poster).authorityClass,'POST');
