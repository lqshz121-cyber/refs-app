...
test('AI accrual repository reads only current Final-1 retained evidence under the explain capability',async()=>{
  ...
  assert.equal(history.length,1);assert.deepEqual(current,['00000000-0000-4000-8000-000000000001']);assert.deepEqual(posted,['00000000-0000-4000-8000-000000000001']);assert.equal(period.period_id,periodId);
