...
function service(domain){
  ...
  const verified={signature_verified:true,raw_contains_credentials:false,admission_blockers:[],snapshot_id:randomUUID(),source_tool:domain==='BANK'?'list_bank_transactions':'list_control_totals',date_from:'2026-08-01',date_to:'2026-08-31',row_count:1,per_currency_totals:[{currency:'USD',gross_amount:'10.0000'}],control_totals_hash:hash('c'),package_hash:hash('d'),raw_package_hash:hash('e'),package:{captured_at:'2026-08-15T00:00:00.000Z'}};
  const plan={status:'NORMALIZED_FINAL1_BUSINESS_EVIDENCE_PLAN',plan_hash:hash('f'),evidence_rows:[{}],can_create_transaction:false,can_create_draft:false,can_review:false,can_approve:false,can_post:false};
