...
const up=await readFile(new URL('../db/migrations/143_wbs_property_rent_pickup.sql',import.meta.url),'utf8');
const down=await readFile(new URL('../db/migrations/down/143_wbs_property_rent_pickup.sql',import.meta.url),'utf8');
