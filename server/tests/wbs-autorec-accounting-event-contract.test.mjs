...
const foundation=await readFile(new URL('../db/migrations/151_wbs_autorec_accounting_event.sql',import.meta.url),'utf8');
const draft=await readFile(new URL('../db/migrations/152_wbs_autorec_g11_draft.sql',import.meta.url),'utf8');
const incurred=await readFile(new URL('../db/migrations/153_wbs_autorec_g11_incurred.sql',import.meta.url),'utf8');
