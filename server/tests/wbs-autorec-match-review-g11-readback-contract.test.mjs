...
const migration=await readFile(new URL('../db/migrations/154_wbs_autorec_match_review_g11_readback.sql',import.meta.url),'utf8');
const down=await readFile(new URL('../db/migrations/down/154_wbs_autorec_match_review_g11_readback.sql',import.meta.url),'utf8');
