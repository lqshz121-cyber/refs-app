...
const migration=await readFile(resolve(here,'../db/migrations/159_insurance_prepaid_amortization_read.sql'),'utf8');
const down=await readFile(resolve(here,'../db/migrations/down/159_insurance_prepaid_amortization_read.sql'),'utf8');
