...
const upPath=new URL('../db/migrations/147_insurance_prepaid_amortization_entity_capabilities.sql',import.meta.url);
const downPath=new URL('../db/migrations/down/147_insurance_prepaid_amortization_entity_capabilities.sql',import.meta.url);

test('147 replaces only insurance readiness capability checks with entity-scoped permissions',async()=>{
