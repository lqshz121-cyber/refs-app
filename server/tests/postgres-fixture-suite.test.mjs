...
test('PostgreSQL fixture suite names each isolated accounting closure explicitly',()=>{
  assert.deepEqual(FIXTURES.map(item=>item.id),['controlled-ap-close','ar-rent-pickup-close','signed-wbs-payable-post','signed-wbs-cost-cwip-post','bank-reconcile-close','signed-wbs-bank-reconciliation-close','ai-exception-lineage','ai-duplicate-payable-audit-read','ai-insurance-amortization-close','real-estate-reports']);
