...
const up=await readFile(new URL('../db/migrations/156_wbs_property_rent_source_admission.sql',import.meta.url),'utf8');
const down=await readFile(new URL('../db/migrations/down/156_wbs_property_rent_source_admission.sql',import.meta.url),'utf8');
