...
const propertyRentOperations=operations.filter(operation=>['reviewWbsPropertyRentPickup','createWbsPropertyRentPickupDraft'].includes(operation.operationId));
