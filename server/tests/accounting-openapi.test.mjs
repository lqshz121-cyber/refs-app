...
test('accounting OpenAPI is 3.1, authenticated and operation ids match the runtime kernel surface',()=>{
  ...
  assert.equal(operationIds.length,103);
  for(const id of ['createNativeApPayment','createNativeArReceipt','createNativeRefund'])assert.ok(operationIds.includes(id));
