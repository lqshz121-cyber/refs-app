...
const flags={can_create_draft:false,can_review:false,can_approve:false,can_post:false},metadata={provider_request_id:'req-1',model:'controlled-model',elapsed_ms:12,trace_id:'full-scan-run-001:chunk:0'};
...
test('rejects omitted chunks, invented or duplicated citations, risk drift, hash drift, authority, and secrets',()=>{
  ...
  const cases=[
    ...
    {chunkResponses:chunks,finalMemo:{...baseMemo,memo_citation_finding_ids:[input.chunks[0].findings[0].finding_id],controller_actions:[{...baseMemo.controller_actions[0],finding_ids:[input.chunks[1].findings[0].finding_id]}]}},
