...
const result=(idempotent=false)=>({wbs_test_bank_import_receipt_id:'00000001-0000-4000-8000-000000000001',receipt_hash:`sha256:${'a'.repeat(64)}`,bank_source_ids:['00000003-0000-4000-8000-000000000001'],bank_account_ref:'WBS_TEST_BANK',statement_ending_date:'2026-08-11',transaction_count:1,status:'FINALIZED',provenance_mode:'CONTROLLED_TEST_UNSIGNED',test_only:true,can_import:false,can_match:false,can_create_draft:false,can_post:false,idempotent});
