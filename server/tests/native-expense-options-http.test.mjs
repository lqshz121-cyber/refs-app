...
const options={schema_version:'NATIVE_EXPENSE_CREATE_OPTIONS_V1',entity_id:entityId,period_id:periodId,vendors:[{vendor_ref:'VENDOR-1',vendor_name:'Vendor'}],bank_cash_accounts:[{bank_member_ref:'BANK-1',bank_name:'Bank',cash_account_code:'111000',cash_account_name:'Cash'}],expense_accounts:[{expense_account_code:'610000',expense_account_name:'Operating expense'}],attachments:[{attachment_id:'44444444-4444-4444-8444-444444444444',name:'support.pdf',media_type:'application/pdf',size_bytes:'1',content_hash:'sha256:'+'0'.repeat(64),verified_at:'2026-07-18T01:00:00.000000Z'}]};
