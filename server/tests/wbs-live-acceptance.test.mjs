...
function evidence(){
  ...
  const receipt={...scope,issuer:'wbs',kid:'wbs-2026',algorithm:'Ed25519',response_sha256:rawHash(raw.response),request_sha256:rawHash(raw.request),nonce:'nonce-1',signed_at:'2026-08-11T00:00:00.000Z',expires_at:'2026-08-12T00:00:00.000Z',immutable_version:'1',nonempty:true,detached_signature:{key_id:'wbs-2026',algorithm:'Ed25519',value:sign(null,Buffer.from(packageHash),pair.privateKey).toString('base64')}};
