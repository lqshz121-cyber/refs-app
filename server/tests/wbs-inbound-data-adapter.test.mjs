...
test('G11 accepts only both posted AutoRec legs with exact source trace and per-member 291001 net zero',()=>{
  ...
  const policyBoundTrace={...review.trace,review_plan_id:'sha256:'+'c'.repeat(64),allocation_edge_id:'sha256:'+'d'.repeat(64),proposal_allocation_edge_id:'sha256:'+'e'.repeat(64),matching_policy:{policy_id:'policy-1',version:'1',mapping_id:'mapping-1',mapping_version:'1',rule_id:'rule-1',rule_version:'1',bank_mapping_id:'bank-map-1',bank_mapping_version:'1',business_mapping_id:'pay-map-1',business_mapping_version:'1',date_match_basis:'BUSINESS_AND_ACCOUNTING',receipt_id:'policy-receipt-1',receipt_ref:'object://receipt/policy-1',receipt_hash:'sha256:'+'f'.repeat(64)}};
