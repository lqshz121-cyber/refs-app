...
const tenantId=id(),sourceEntityId=id(),targetEntityId=id(),sourcePeriodId=id(),targetPeriodId=id(),pairId=id(),unitControlId=id(),sourceDocumentId=id(),sourceDocumentLineId=id(),sourceJournalId=id(),targetJournalId=id(),sourceMappingId=id(),targetMappingId=id(),sourceAttachmentId=id(),targetAttachmentId=id(),costLineId=id();
const noActions={can_create_draft:false,can_submit:false,can_review:false,can_approve:false,can_reject:false,can_cancel:false,can_post:false};
