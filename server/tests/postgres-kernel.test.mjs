...
pgTest('admitted signed Payable composition persists receipt Raw Normalized Staging and replays with zero journal writes',async()=>{
  ...
  const rows=[{ap_guid:sourceId,ap_type:'AUTOC',company_code:ids.sourceEntityId,currency:'USD',amount:'89.1250',incurred_date:'2026-07-10',posting_date:'2026-07-11',pay_due_date:'2026-07-31',invoice_no:'WBS-INV-PG-001',vendor_no:'VENDOR-PG'}];
