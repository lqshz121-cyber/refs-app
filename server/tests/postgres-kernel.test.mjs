...
pgTest('WBS H1 control reconciliation binds six exact provider-signed Payables periods to one Posted ledger population and rejects drift',async()=>{
  ...
  const reconciler=new PostgresAccountingKernel(runtimePool,{sessionProvider:sessionProvider(ids,'wbs-h1-reconciliation-service',['AI.ANALYSIS.EXPLAIN','AI.ACCOUNTING.SETTINGS.VIEW','WBS.AUTOREC.VIEW'])});
