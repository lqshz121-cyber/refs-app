...
const result={status:'WBS_TEST_MONTH_IMPORT_COMPLETE',period_code:'2026-01',date_from:'2026-01-01',date_to:'2026-01-31',page_size:10,payables:{provider_page_count:124,h1_record_count:1237,record_count:1,imported_count:1,replayed_count:0,posted_count:1},bank:{provider_page_count:1,record_count:1,reconciliation:{bank_account_ref:'WBS_TEST_BANK_2026_01',period_code:'2026-01',period_id:'00000000-0000-4000-8000-000000000006',reconciliation_id:'00000000-0000-4000-8000-000000000004',transaction_count:1},bank_source_count:1},test_only:true};
