...
const isoDateValue=value=>value instanceof Date?value.toISOString().slice(0,10):value;
const aiInvoiceAccrualProposalDto=value=>({ai_invoice_accrual_proposal_id:value.ai_invoice_accrual_proposal_id,classification_evidence_id:value.ai_invoice_accounting_classification_evidence_id,classification_hash:value.classification_hash,source_document_id:value.source_document_id,source_document_line_id:value.source_document_line_id,source_payload_hash:value.source_payload_hash,source_line_hash:value.source_line_hash,accounting_period_id:value.accounting_period_id,expense_account_code:value.expense_account_code,liability_account_code:value.liability_account_code,currency:value.currency,amount:String(value.amount),member_trace:value.member_trace,reversal_decision:value.reversal_decision,reversal_date:value.reversal_date==null?null:isoDateValue(value.reversal_date),rule_id:value.rule_id,confidence:Number(value.confidence),proposal_reason:value.proposal_reason,proposal_hash:value.proposal_hash,status:value.status,created_at:value.created_at instanceof Date?value.created_at.toISOString():value.created_at,can_create_draft:false,can_review:false,can_approve:false,can_post:false});
const aiInvoiceAccrualEvidenceDto=value=>({classification_evidence_id:value.ai_invoice_accounting_classification_evidence_id,accounting_period_id:value.accounting_period_id,source_document_id:value.source_document_id,source_document_line_id:value.source_document_line_id,source_payload_hash:value.source_payload_hash,source_line_hash:value.source_line_hash,classifier_version:value.classifier_version,classification:value.classification,reason:value.reason,confidence:Number(value.confidence),required_human_fields:value.required_human_fields,rule_id:value.rule_id,classification_hash:value.classification_hash,status:value.status,created_at:value.created_at instanceof Date?value.created_at.toISOString():value.created_at,can_create_draft:false,can_review:false,can_approve:false,can_post:false});
const aiInvoiceCapitalizationEvidenceDto=value=>({classification_evidence_id:value.ai_invoice_accounting_classification_evidence_id,accounting_period_id:value.accounting_period_id,source_document_id:value.source_document_id,source_document_line_id:value.source_document_line_id,source_payload_hash:value.source_payload_hash,source_line_hash:value.source_line_hash,classifier_version:value.classifier_version,classification:value.classification,reason:value.reason,confidence:Number(value.confidence),required_human_fields:value.required_human_fields,rule_id:value.rule_id,policy_snapshot_id:value.policy_snapshot_id,policy_snapshot_hash:value.policy_snapshot_hash,classification_hash:value.classification_hash,status:value.status,created_at:value.created_at instanceof Date?value.created_at.toISOString():value.created_at,can_create_draft:false,can_review:false,can_approve:false,can_post:false});
const aiInvoiceCapitalizationProposalDto=value=>({ai_invoice_capitalization_proposal_id:value.ai_invoice_capitalization_proposal_id,classification_evidence_id:value.ai_invoice_accounting_classification_evidence_id,classification_hash:value.classification_hash,source_document_id:value.source_document_id,source_document_line_id:value.source_document_line_id,source_payload_hash:value.source_payload_hash,source_line_hash:value.source_line_hash,accounting_period_id:value.accounting_period_id,capitalization_treatment:value.capitalization_treatment,asset_account_code:value.asset_account_code,liability_account_code:value.liability_account_code,asset_class:value.asset_class,currency:value.currency,amount:String(value.amount),member_trace:value.member_trace,placed_in_service_date:value.placed_in_service_date==null?null:isoDateValue(value.placed_in_service_date),useful_life_months:value.useful_life_months==null?null:Number(value.useful_life_months),rule_id:value.rule_id,policy_snapshot_id:value.policy_snapshot_id,policy_snapshot_hash:value.policy_snapshot_hash,confidence:Number(value.confidence),proposal_reason:value.proposal_reason,proposal_hash:value.proposal_hash,status:value.status,created_at:value.created_at instanceof Date?value.created_at.toISOString():value.created_at,can_create_draft:false,can_review:false,can_approve:false,can_post:false});
const aiInvoiceExpenseEvidenceDto=value=>({classification_evidence_id:value.ai_invoice_accounting_classification_evidence_id,accounting_period_id:value.accounting_period_id,source_document_id:value.source_document_id,source_document_line_id:value.source_document_line_id,source_payload_hash:value.source_payload_hash,source_line_hash:value.source_line_hash,classifier_version:value.classifier_version,classification:value.classification,reason:value.reason,confidence:Number(value.confidence),required_human_fields:value.required_human_fields,rule_id:value.rule_id,policy_snapshot_id:value.policy_snapshot_id,policy_snapshot_hash:value.policy_snapshot_hash,classification_hash:value.classification_hash,status:value.status,created_at:value.created_at instanceof Date?value.created_at.toISOString():value.created_at,can_create_draft:false,can_review:false,can_approve:false,can_post:false});
const aiInvoiceExpenseProposalDto=value=>({ai_invoice_expense_proposal_id:value.ai_invoice_expense_proposal_id,classification_evidence_id:value.ai_invoice_accounting_classification_evidence_id,classification_hash:value.classification_hash,source_document_id:value.source_document_id,source_document_line_id:value.source_document_line_id,source_payload_hash:value.source_payload_hash,source_line_hash:value.source_line_hash,accounting_period_id:value.accounting_period_id,expense_account_code:value.expense_account_code,liability_account_code:value.liability_account_code,currency:value.currency,amount:String(value.amount),member_trace:value.member_trace,rule_id:value.rule_id,policy_snapshot_id:value.policy_snapshot_id,policy_snapshot_hash:value.policy_snapshot_hash,confidence:Number(value.confidence),proposal_reason:value.proposal_reason,proposal_hash:value.proposal_hash,status:value.status,created_at:value.created_at instanceof Date?value.created_at.toISOString():value.created_at,can_create_draft:false,can_review:false,can_approve:false,can_post:false});
const aiConstructionLoanClassificationDto=value=>({ai_construction_loan_classification_evidence_id:value.ai_construction_loan_classification_evidence_id,source_document_id:value.source_document_id,source_document_line_id:value.source_document_line_id,source_payload_hash:value.source_payload_hash,source_document_version:Number(value.source_document_version),source_line_hash:value.source_line_hash,loan_ref:value.loan_ref,classification:value.classification,rule_id:value.rule_id,reason:value.reason,confidence:Number(value.confidence),required_human_fields:value.required_human_fields,entry_shape:value.entry_shape,classification_hash:value.classification_hash,status:value.status,created_at:value.created_at instanceof Date?value.created_at.toISOString():value.created_at,can_create_draft:false,can_review:false,can_approve:false,can_post:false});
const aiConstructionLoanEntryProposalDto=value=>({ai_construction_loan_entry_proposal_id:value.ai_construction_loan_entry_proposal_id,classification_evidence_id:value.ai_construction_loan_classification_evidence_id,classification_hash:value.classification_hash,source_document_id:value.source_document_id,source_document_line_id:value.source_document_line_id,source_payload_hash:value.source_payload_hash,source_document_version:Number(value.source_document_version),source_line_hash:value.source_line_hash,accounting_period_id:value.accounting_period_id,journal_date:isoDateValue(value.journal_date),loan_ref:value.loan_ref,classification:value.classification,treatment_decision:value.treatment_decision,debit_account_code:value.debit_account_code,credit_account_code:value.credit_account_code,currency:value.currency,amount:String(value.amount),member_trace:value.member_trace,rule_id:value.rule_id,confidence:Number(value.confidence),proposal_reason:value.proposal_reason,proposal_hash:value.proposal_hash,status:value.status,created_at:value.created_at instanceof Date?value.created_at.toISOString():value.created_at,can_create_draft:false,can_review:false,can_approve:false,can_post:false});
...
export function createAccountingApi({authenticate,kernelFactory,attachmentServiceFactory,wbsReadServiceFactory,wbsLivePilotServiceFactory,wbsTestImportServiceFactory,controlledTestAiWorkflowServiceFactory,wbsAdmittedPayableServiceFactory,wbsProviderSignedPayableServiceFactory,wbsProviderFinal1RetainedEvidenceServiceFactory,wbsOperatorAttestedPayableServiceFactory,aiAnalysisExplanationServiceFactory,aiAccrualCandidateAnalysisServiceFactory,aiInvoiceAccountingClassificationServiceFactory,stage1SelfGrantServiceFactory,stage1SelfWbsReadUpgradeServiceFactory,stage1SelfWbsOperatorUpgradeServiceFactory,stage1SelfControlledTestWorkflowUpgradeServiceFactory}={}){
  ...
  return async function dispatch({method,url,headers={},body=null}){
    try{
      ...
      if(method==='GET'&&parts.length===7&&parts[4]==='ai'&&parts[5]==='invoice-accrual'&&parts[6]==='evidence'){
        if(header(headers,'idempotency-key')!=null||header(headers,'if-match')!=null)throw new AccountingApiError(400,'READ_COMMAND_HEADERS_FORBIDDEN','Invoice accrual evidence reads do not accept command headers');
        if(body!==null)throw new AccountingApiError(400,'READ_BODY_FORBIDDEN','Read operations do not accept a request body');
        requireExactQuery(parsedUrl.searchParams,['periodId','limit']);const periodId=requireUuid(parsedUrl.searchParams.get('periodId'),'periodId'),rawLimit=parsedUrl.searchParams.get('limit'),limit=rawLimit==null?100:Number(rawLimit);
        ...
        const kernel=await kernelFactory(principal);if(!kernel||typeof kernel.listAiInvoiceAccountingClassificationEvidence!=='function')throw new AccountingApiError(503,'AI_INVOICE_ACCRUAL_EVIDENCE_READ_UNAVAILABLE','Retained invoice accounting classification evidence is unavailable');
        result=await kernel.listAiInvoiceAccountingClassificationEvidence({tenantId:principal.tenantId,entityId,accountingPeriodId:periodId,limit});
        return {status:200,headers:{'content-type':'application/json','cache-control':'no-store'},body:{ok:true,data:result.filter(row=>row.classification==='ACCRUAL_REVIEW').map(aiInvoiceAccrualEvidenceDto)}};
      }
      if(method==='GET'&&parts.length===7&&parts[4]==='ai'&&parts[5]==='invoice-accrual'&&parts[6]==='proposals'){
        if(header(headers,'idempotency-key')!=null||header(headers,'if-match')!=null)throw new AccountingApiError(400,'READ_COMMAND_HEADERS_FORBIDDEN','Invoice accrual proposal reads do not accept command headers');
        if(body!==null)throw new AccountingApiError(400,'READ_BODY_FORBIDDEN','Read operations do not accept a request body');
        ...
        if(!Number.isSafeInteger(limit)||limit<1||limit>100)throw new AccountingApiError(400,'INVALID_LIMIT','limit must be an integer from 1 to 100');
        const kernel=await kernelFactory(principal);if(!kernel||typeof kernel.listAiInvoiceAccrualProposals!=='function')throw new AccountingApiError(503,'AI_INVOICE_ACCRUAL_PROPOSAL_READ_UNAVAILABLE','Persisted invoice accrual proposals are unavailable');
        result=await kernel.listAiInvoiceAccrualProposals({tenantId:principal.tenantId,entityId,limit});
        return {status:200,headers:{'content-type':'application/json','cache-control':'no-store'},body:{ok:true,data:result.map(aiInvoiceAccrualProposalDto)}};
      }
      if(method==='GET'&&parts.length===7&&parts[4]==='ai'&&parts[5]==='invoice-capitalization'&&parts[6]==='evidence'){
        if(header(headers,'idempotency-key')!=null||header(headers,'if-match')!=null)throw new AccountingApiError(400,'READ_COMMAND_HEADERS_FORBIDDEN','Invoice capitalization evidence reads do not accept command headers');
        if(body!==null)throw new AccountingApiError(400,'READ_BODY_FORBIDDEN','Read operations do not accept a request body');
        requireExactQuery(parsedUrl.searchParams,['periodId','limit']);const periodId=requireUuid(parsedUrl.searchParams.get('periodId'),'periodId'),rawLimit=parsedUrl.searchParams.get('limit'),limit=rawLimit==null?100:Number(rawLimit);
        if(!Number.isSafeInteger(limit)||limit<1||limit>500)throw new AccountingApiError(400,'INVALID_LIMIT','limit must be an integer from 1 to 500');
        const kernel=await kernelFactory(principal);if(!kernel||typeof kernel.listAiInvoiceAccountingClassificationEvidence!=='function')throw new AccountingApiError(503,'AI_INVOICE_CAPITALIZATION_EVIDENCE_READ_UNAVAILABLE','Retained invoice accounting classification evidence is unavailable');
        result=await kernel.listAiInvoiceAccountingClassificationEvidence({tenantId:principal.tenantId,entityId,accountingPeriodId:periodId,limit});
        return {status:200,headers:{'content-type':'application/json','cache-control':'no-store'},body:{ok:true,data:result.filter(row=>row.classification==='CAPITALIZATION_REVIEW'&&row.rule_id==='AI_CAPITALIZATION_POLICY_V1').map(aiInvoiceCapitalizationEvidenceDto)}};
      }
      if(method==='GET'&&parts.length===7&&parts[4]==='ai'&&parts[5]==='invoice-capitalization'&&parts[6]==='proposals'){
        if(header(headers,'idempotency-key')!=null||header(headers,'if-match')!=null)throw new AccountingApiError(400,'READ_COMMAND_HEADERS_FORBIDDEN','Invoice capitalization proposal reads do not accept command headers');
        if(body!==null)throw new AccountingApiError(400,'READ_BODY_FORBIDDEN','Read operations do not accept a request body');
        requireExactQuery(parsedUrl.searchParams,['limit']);const rawLimit=parsedUrl.searchParams.get('limit'),limit=rawLimit==null?50:Number(rawLimit);
        if(!Number.isSafeInteger(limit)||limit<1||limit>100)throw new AccountingApiError(400,'INVALID_LIMIT','limit must be an integer from 1 to 100');
        const kernel=await kernelFactory(principal);if(!kernel||typeof kernel.listAiInvoiceCapitalizationProposals!=='function')throw new AccountingApiError(503,'AI_INVOICE_CAPITALIZATION_PROPOSAL_READ_UNAVAILABLE','Persisted invoice capitalization proposals are unavailable');
        result=await kernel.listAiInvoiceCapitalizationProposals({tenantId:principal.tenantId,entityId,limit});
        return {status:200,headers:{'content-type':'application/json','cache-control':'no-store'},body:{ok:true,data:result.map(aiInvoiceCapitalizationProposalDto)}};
      }
      if(method==='GET'&&parts.length===7&&parts[4]==='ai'&&parts[5]==='invoice-expense'&&parts[6]==='evidence'){
        if(header(headers,'idempotency-key')!=null||header(headers,'if-match')!=null)throw new AccountingApiError(400,'READ_COMMAND_HEADERS_FORBIDDEN','Invoice expense evidence reads do not accept command headers');
        if(body!==null)throw new AccountingApiError(400,'READ_BODY_FORBIDDEN','Read operations do not accept a request body');
        requireExactQuery(parsedUrl.searchParams,['periodId','limit']);const periodId=requireUuid(parsedUrl.searchParams.get('periodId'),'periodId'),rawLimit=parsedUrl.searchParams.get('limit'),limit=rawLimit==null?100:Number(rawLimit);
        if(!Number.isSafeInteger(limit)||limit<1||limit>500)throw new AccountingApiError(400,'INVALID_LIMIT','limit must be an integer from 1 to 500');
        const kernel=await kernelFactory(principal);if(!kernel||typeof kernel.listAiInvoiceAccountingClassificationEvidence!=='function')throw new AccountingApiError(503,'AI_INVOICE_EXPENSE_EVIDENCE_READ_UNAVAILABLE','Retained invoice accounting classification evidence is unavailable');
        result=await kernel.listAiInvoiceAccountingClassificationEvidence({tenantId:principal.tenantId,entityId,accountingPeriodId:periodId,limit});
        return {status:200,headers:{'content-type':'application/json','cache-control':'no-store'},body:{ok:true,data:result.filter(row=>row.classification==='EXPENSE'&&['AI_ORDINARY_EXPENSE_V1','AI_CAPITALIZATION_POLICY_V1'].includes(row.rule_id)).map(aiInvoiceExpenseEvidenceDto)}};
      }
      if(method==='GET'&&parts.length===7&&parts[4]==='ai'&&parts[5]==='invoice-expense'&&parts[6]==='proposals'){
        if(header(headers,'idempotency-key')!=null||header(headers,'if-match')!=null)throw new AccountingApiError(400,'READ_COMMAND_HEADERS_FORBIDDEN','Invoice expense proposal reads do not accept command headers');
        if(body!==null)throw new AccountingApiError(400,'READ_BODY_FORBIDDEN','Read operations do not accept a request body');
        requireExactQuery(parsedUrl.searchParams,['limit']);const rawLimit=parsedUrl.searchParams.get('limit'),limit=rawLimit==null?50:Number(rawLimit);
        if(!Number.isSafeInteger(limit)||limit<1||limit>100)throw new AccountingApiError(400,'INVALID_LIMIT','limit must be an integer from 1 to 100');
        const kernel=await kernelFactory(principal);if(!kernel||typeof kernel.listAiInvoiceExpenseProposals!=='function')throw new AccountingApiError(503,'AI_INVOICE_EXPENSE_PROPOSAL_READ_UNAVAILABLE','Persisted invoice expense proposals are unavailable');
        result=await kernel.listAiInvoiceExpenseProposals({tenantId:principal.tenantId,entityId,limit});
        return {status:200,headers:{'content-type':'application/json','cache-control':'no-store'},body:{ok:true,data:result.map(aiInvoiceExpenseProposalDto)}};
      }
      if(method==='GET'&&parts.length===7&&parts[4]==='ai'&&parts[5]==='construction-loan'&&parts[6]==='classifications'){
        if(header(headers,'idempotency-key')!=null||header(headers,'if-match')!=null)throw new AccountingApiError(400,'READ_COMMAND_HEADERS_FORBIDDEN','Construction loan classification reads do not accept command headers');
        if(body!==null)throw new AccountingApiError(400,'READ_BODY_FORBIDDEN','Read operations do not accept a request body');
        requireExactQuery(parsedUrl.searchParams,['limit']);const rawLimit=parsedUrl.searchParams.get('limit'),limit=rawLimit==null?50:Number(rawLimit);
        if(!Number.isSafeInteger(limit)||limit<1||limit>100)throw new AccountingApiError(400,'INVALID_LIMIT','limit must be an integer from 1 to 100');
        const kernel=await kernelFactory(principal);if(!kernel||typeof kernel.listAiConstructionLoanClassifications!=='function')throw new AccountingApiError(503,'AI_CONSTRUCTION_LOAN_CLASSIFICATION_READ_UNAVAILABLE','Persisted construction loan classifications are unavailable');
        result=await kernel.listAiConstructionLoanClassifications({tenantId:principal.tenantId,entityId,limit});
        return {status:200,headers:{'content-type':'application/json','cache-control':'no-store'},body:{ok:true,data:result.map(aiConstructionLoanClassificationDto)}};
      }
      if(method==='GET'&&parts.length===7&&parts[4]==='ai'&&parts[5]==='construction-loan'&&parts[6]==='entry-proposals'){
        if(header(headers,'idempotency-key')!=null||header(headers,'if-match')!=null)throw new AccountingApiError(400,'READ_COMMAND_HEADERS_FORBIDDEN','Construction loan proposal reads do not accept command headers');
        if(body!==null)throw new AccountingApiError(400,'READ_BODY_FORBIDDEN','Read operations do not accept a request body');
        requireExactQuery(parsedUrl.searchParams,['limit']);const rawLimit=parsedUrl.searchParams.get('limit'),limit=rawLimit==null?50:Number(rawLimit);
        if(!Number.isSafeInteger(limit)||limit<1||limit>100)throw new AccountingApiError(400,'INVALID_LIMIT','limit must be an integer from 1 to 100');
        const kernel=await kernelFactory(principal);if(!kernel||typeof kernel.listAiConstructionLoanEntryProposals!=='function')throw new AccountingApiError(503,'AI_CONSTRUCTION_LOAN_ENTRY_PROPOSAL_READ_UNAVAILABLE','Persisted construction loan entry proposals are unavailable');
        result=await kernel.listAiConstructionLoanEntryProposals({tenantId:principal.tenantId,entityId,limit});
        return {status:200,headers:{'content-type':'application/json','cache-control':'no-store'},body:{ok:true,data:result.map(aiConstructionLoanEntryProposalDto)}};
      }
      ...
      if(parts.length===7&&parts[4]==='wbs'&&parts[5]==='insurance'&&parts[6]==='pc-mapping-proposals'){
      ...
      }else if(parts.length===7&&parts[4]==='ai'&&parts[5]==='invoice-accrual'&&parts[6]==='proposals'){
        requireExactQuery(parsedUrl.searchParams,[]);if(header(headers,'if-match')!=null)throw new AccountingApiError(400,'IF_MATCH_NOT_ALLOWED','Invoice accrual proposals use immutable classification hashes, not If-Match');
        allowOnly(payload,['classificationEvidenceId','classificationHash','accountingPeriodId','expenseAccountCode','liabilityAccountCode','memberTrace','reversalDecision','reversalDate','reason']);
        const reversalDecision=payload.reversalDecision;if(!['REVERSE_NEXT_OPEN_PERIOD','NO_AUTOMATIC_REVERSAL'].includes(reversalDecision))throw new AccountingApiError(400,'INVALID_REVERSAL_DECISION','reversalDecision must be REVERSE_NEXT_OPEN_PERIOD or NO_AUTOMATIC_REVERSAL');
        const reversalDate=payload.reversalDate===null?null:requireIsoDate(payload.reversalDate,'reversalDate');if((reversalDecision==='REVERSE_NEXT_OPEN_PERIOD')!==(reversalDate!==null))throw new AccountingApiError(400,'INVALID_REVERSAL_DECISION','A reversal date is required only for REVERSE_NEXT_OPEN_PERIOD');
        const kernel=await kernelFactory(principal);if(!kernel||typeof kernel.proposeAiInvoiceAccrual!=='function')throw new AccountingApiError(503,'AI_INVOICE_ACCRUAL_PROPOSAL_UNAVAILABLE','Invoice accrual proposal persistence is unavailable');
        result=await kernel.proposeAiInvoiceAccrual({tenantId:principal.tenantId,entityId,classificationEvidenceId:requireUuid(payload.classificationEvidenceId,'classificationEvidenceId'),classificationHash:requireSha256(payload.classificationHash,'classificationHash'),accountingPeriodId:requireUuid(payload.accountingPeriodId,'accountingPeriodId'),expenseAccountCode:requireAccountCode(payload.expenseAccountCode),liabilityAccountCode:requireAccountCode(payload.liabilityAccountCode),memberTrace:requireAiAmortizationMemberTrace(payload.memberTrace),reversalDecision,reversalDate,reason:requireReviewReason(payload.reason),idempotencyKey});
        if(!result||result.schema_version!=='AI_INVOICE_ACCRUAL_PROPOSAL_V1'||result.status!=='PROPOSED'||!UUID.test(result.ai_invoice_accrual_proposal_id||'')||result.can_create_draft!==false||result.can_review!==false||result.can_approve!==false||result.can_post!==false)throw new AccountingApiError(500,'AI_INVOICE_ACCRUAL_PROPOSAL_RESULT_INVALID','Invoice accrual proposal must remain immutable analysis evidence without journal authority');
      }else if(parts.length===7&&parts[4]==='ai'&&parts[5]==='invoice-capitalization'&&parts[6]==='proposals'){
        requireExactQuery(parsedUrl.searchParams,[]);if(header(headers,'if-match')!=null)throw new AccountingApiError(400,'IF_MATCH_NOT_ALLOWED','Invoice capitalization proposals use immutable classification hashes, not If-Match');
        allowOnly(payload,['classificationEvidenceId','classificationHash','accountingPeriodId','capitalizationTreatment','assetAccountCode','liabilityAccountCode','assetClass','memberTrace','placedInServiceDate','usefulLifeMonths','reason']);
        const treatment=payload.capitalizationTreatment;if(!['CWIP','FIXED_ASSET'].includes(treatment))throw new AccountingApiError(400,'INVALID_CAPITALIZATION_TREATMENT','capitalizationTreatment must be CWIP or FIXED_ASSET');
        const placedInServiceDate=payload.placedInServiceDate===null?null:requireIsoDate(payload.placedInServiceDate,'placedInServiceDate'),usefulLifeMonths=payload.usefulLifeMonths===null?null:Number(payload.usefulLifeMonths);
        if((treatment==='CWIP'&&(placedInServiceDate!==null||usefulLifeMonths!==null))||(treatment==='FIXED_ASSET'&&(placedInServiceDate===null||!Number.isSafeInteger(usefulLifeMonths)||usefulLifeMonths<1||usefulLifeMonths>600)))throw new AccountingApiError(400,'INVALID_CAPITALIZATION_TREATMENT','CWIP cannot be placed in service; fixed assets require a date and useful life from 1 to 600 months');
        const assetClass=typeof payload.assetClass==='string'?payload.assetClass.trim():'';if(assetClass.length<1||assetClass.length>128)throw new AccountingApiError(400,'INVALID_ASSET_CLASS','assetClass must be between 1 and 128 characters');
        const kernel=await kernelFactory(principal);if(!kernel||typeof kernel.proposeAiInvoiceCapitalization!=='function')throw new AccountingApiError(503,'AI_INVOICE_CAPITALIZATION_PROPOSAL_UNAVAILABLE','Invoice capitalization proposal persistence is unavailable');
        result=await kernel.proposeAiInvoiceCapitalization({tenantId:principal.tenantId,entityId,classificationEvidenceId:requireUuid(payload.classificationEvidenceId,'classificationEvidenceId'),classificationHash:requireSha256(payload.classificationHash,'classificationHash'),accountingPeriodId:requireUuid(payload.accountingPeriodId,'accountingPeriodId'),capitalizationTreatment:treatment,assetAccountCode:requireAccountCode(payload.assetAccountCode),liabilityAccountCode:requireAccountCode(payload.liabilityAccountCode),assetClass,memberTrace:requireAiAmortizationMemberTrace(payload.memberTrace),placedInServiceDate,usefulLifeMonths,reason:requireReviewReason(payload.reason),idempotencyKey});
        if(!result||result.schema_version!=='AI_INVOICE_CAPITALIZATION_PROPOSAL_V1'||result.status!=='PROPOSED'||!UUID.test(result.ai_invoice_capitalization_proposal_id||'')||result.can_create_draft!==false||result.can_review!==false||result.can_approve!==false||result.can_post!==false)throw new AccountingApiError(500,'AI_INVOICE_CAPITALIZATION_PROPOSAL_RESULT_INVALID','Invoice capitalization proposal must remain immutable analysis evidence without journal authority');
        ...
        const kernel=await kernelFactory(principal);if(!kernel||typeof kernel.proposeAiInvoiceExpense!=='function')throw new AccountingApiError(503,'AI_INVOICE_EXPENSE_PROPOSAL_UNAVAILABLE','Invoice expense proposal persistence is unavailable');
        result=await kernel.proposeAiInvoiceExpense({tenantId:principal.tenantId,entityId,classificationEvidenceId:requireUuid(payload.classificationEvidenceId,'classificationEvidenceId'),classificationHash:requireSha256(payload.classificationHash,'classificationHash'),accountingPeriodId:requireUuid(payload.accountingPeriodId,'accountingPeriodId'),expenseAccountCode:requireAccountCode(payload.expenseAccountCode),liabilityAccountCode:requireAccountCode(payload.liabilityAccountCode),memberTrace:requireAiAmortizationMemberTrace(payload.memberTrace),reason:requireReviewReason(payload.reason),idempotencyKey});
        if(!result||result.schema_version!=='AI_INVOICE_EXPENSE_PROPOSAL_V1'||result.status!=='PROPOSED'||!UUID.test(result.ai_invoice_expense_proposal_id||'')||result.can_create_draft!==false||result.can_review!==false||result.can_approve!==false||result.can_post!==false)throw new AccountingApiError(500,'AI_INVOICE_EXPENSE_PROPOSAL_RESULT_INVALID','Invoice expense proposal must remain immutable analysis evidence without journal authority');
      }else if(parts.length===7&&parts[4]==='ai'&&parts[5]==='construction-loan'&&parts[6]==='classifications'){
        requireExactQuery(parsedUrl.searchParams,[]);if(header(headers,'if-match')!=null)throw new AccountingApiError(400,'IF_MATCH_NOT_ALLOWED','Construction loan classification uses immutable source evidence, not If-Match');
        allowOnly(payload,['sourceDocumentLineId','expectedClassification']);
        const expectedClassification=payload.expectedClassification;if(!['LOAN_DRAW','INTEREST_REVIEW','PRINCIPAL_REPAYMENT','LOAN_FEE_REVIEW','ESCROW_RESERVE'].includes(expectedClassification))throw new AccountingApiError(400,'INVALID_LOAN_CLASSIFICATION','expectedClassification is not a supported construction loan treatment');
        const kernel=await kernelFactory(principal);if(!kernel||typeof kernel.classifyAiConstructionLoanLine!=='function')throw new AccountingApiError(503,'AI_CONSTRUCTION_LOAN_CLASSIFICATION_UNAVAILABLE','Construction loan classification persistence is unavailable');
        result=await kernel.classifyAiConstructionLoanLine({tenantId:principal.tenantId,entityId,sourceDocumentLineId:requireUuid(payload.sourceDocumentLineId,'sourceDocumentLineId'),expectedClassification,idempotencyKey});
        if(!result||result.schema_version!=='AI_CONSTRUCTION_LOAN_CLASSIFICATION_V1'||result.status!=='REVIEW_REQUIRED'||result.classification!==expectedClassification||!UUID.test(result.ai_construction_loan_classification_evidence_id||'')||result.can_create_draft!==false||result.can_review!==false||result.can_approve!==false||result.can_post!==false)throw new AccountingApiError(500,'AI_CONSTRUCTION_LOAN_CLASSIFICATION_RESULT_INVALID','Construction loan classification must remain source-bound review evidence without journal authority');
      }else if(parts.length===7&&parts[4]==='ai'&&parts[5]==='construction-loan'&&parts[6]==='entry-proposals'){
        requireExactQuery(parsedUrl.searchParams,[]);if(header(headers,'if-match')!=null)throw new AccountingApiError(400,'IF_MATCH_NOT_ALLOWED','Construction loan proposals use immutable classification hashes, not If-Match');
        allowOnly(payload,['classificationEvidenceId','classificationHash','accountingPeriodId','treatmentDecision','debitAccountCode','creditAccountCode','memberTrace','reason']);
        const treatmentDecision=payload.treatmentDecision;if(!['LOAN_DRAW_CASH','LOAN_DRAW_CWIP','CAPITALIZED_INTEREST','EXPENSED_INTEREST','PRINCIPAL_REPAYMENT','DEFERRED_LOAN_FEE','EXPENSED_LOAN_FEE','ESCROW_FUNDING','ESCROW_RELEASE'].includes(treatmentDecision))throw new AccountingApiError(400,'INVALID_LOAN_TREATMENT','treatmentDecision is not a supported construction loan accounting treatment');
        const kernel=await kernelFactory(principal);if(!kernel||typeof kernel.proposeAiConstructionLoanEntry!=='function')throw new AccountingApiError(503,'AI_CONSTRUCTION_LOAN_ENTRY_PROPOSAL_UNAVAILABLE','Construction loan entry proposal persistence is unavailable');
        result=await kernel.proposeAiConstructionLoanEntry({tenantId:principal.tenantId,entityId,classificationEvidenceId:requireUuid(payload.classificationEvidenceId,'classificationEvidenceId'),classificationHash:requireSha256(payload.classificationHash,'classificationHash'),accountingPeriodId:requireUuid(payload.accountingPeriodId,'accountingPeriodId'),treatmentDecision,debitAccountCode:requireAccountCode(payload.debitAccountCode),creditAccountCode:requireAccountCode(payload.creditAccountCode),memberTrace:requireAiAmortizationMemberTrace(payload.memberTrace),reason:requireReviewReason(payload.reason),idempotencyKey});
        if(!result||result.schema_version!=='AI_CONSTRUCTION_LOAN_ENTRY_PROPOSAL_V1'||result.status!=='PROPOSED'||!UUID.test(result.ai_construction_loan_entry_proposal_id||'')||result.can_create_draft!==false||result.can_review!==false||result.can_approve!==false||result.can_post!==false)throw new AccountingApiError(500,'AI_CONSTRUCTION_LOAN_ENTRY_PROPOSAL_RESULT_INVALID','Construction loan proposal must remain source-bound balanced evidence without journal authority');
