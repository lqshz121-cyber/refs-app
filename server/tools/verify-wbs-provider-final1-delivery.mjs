...
export function main(argv=process.argv.slice(2)){
  const options=parse(argv),required=['provider-trust','receipt','request-raw','response-raw','package-raw','tenant-id','entity-id','company-code'];
