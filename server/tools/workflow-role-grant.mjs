...
import {authoritativeWorkflowRoleGrantConfig,grantAuthenticatedWorkflowRole} from '../runtime/workflow-role-grant.mjs';
...
try{
  ...
  const result=await grantAuthenticatedWorkflowRole(pool,config);
