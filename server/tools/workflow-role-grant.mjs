...
import {authoritativeWorkflowRoleGrantConfig,grantStagingWorkflowRole} from '../runtime/workflow-role-grant.mjs';
...
try{
  ...
  const result=await grantStagingWorkflowRole(pool,config,{installationId:process.env.REFS_EXPECTED_INSTALLATION_ID||null,expectedDatabase:process.env.REFS_EXPECTED_DATABASE_NAME||null});
