...
VALUES('FIXED_ASSET.ACQUISITION.DRAFT','FIXED_ASSET','HIGH','FIXED_ASSET_ACQUISITION_MAKER')
...
VALUES('FIXED_ASSET.ACQUISITION.DRAFT','DRAFT') ON CONFLICT(permission_code) DO NOTHING;
