...
DO $$ DECLARE definition text; BEGIN
  ...
  IF position('ai_bank_duplicate_payment_finding_id=p_finding' IN definition)=0 OR position('ai_vendor_invoice_amount_anomaly_finding_id=p_finding' IN definition)=0 OR position('ai_vendor_invoice_frequency_anomaly_finding_id=p_finding' IN definition)=0 OR position('ai_vendor_invoice_amount_drop_finding_id=p_finding' IN definition)=0 OR position('ai_vendor_invoice_near_duplicate_finding_id=p_finding' IN definition)=0 OR position('ai_manual_journal_risk_finding_id=p_finding' IN definition)=0 THEN RAISE EXCEPTION 'AI anomaly assignment integration failed'; END IF;
  EXECUTE definition;
