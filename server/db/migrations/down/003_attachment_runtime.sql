...
DROP FUNCTION IF EXISTS refs_finalize_attachment(uuid,uuid,uuid,bigint,text,text,text,boolean,text,text,text);
DROP FUNCTION IF EXISTS refs_attachment_finalize_hash(uuid,uuid,uuid,bigint,text,text,text,boolean,text);
