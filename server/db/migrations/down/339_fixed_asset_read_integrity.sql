BEGIN;
DROP INDEX fixed_asset_movement_page;
DROP FUNCTION refs_read_fixed_asset_movements(uuid,uuid,uuid,date,integer,text);
DROP FUNCTION refs_asset_trace_cursor(jsonb),refs_asset_trace_cursor_read(text);
DROP FUNCTION refs_read_fixed_asset_register_v2(uuid,uuid,date,integer,text,uuid);
DROP TABLE fixed_asset_read_cursor_key;
