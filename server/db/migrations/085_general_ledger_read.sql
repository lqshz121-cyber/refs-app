...
-- Paginated General Ledger detail.  This is an evidence read only: it is
-- deliberately derived only from the already POSTED immutable ledger.
CREATE FUNCTION refs_list_general_ledger(
