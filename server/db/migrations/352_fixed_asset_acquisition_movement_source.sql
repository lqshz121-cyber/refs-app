...
BEGIN
 ...
 LEFT JOIN LATERAL(
  SELECT retained.*,count(*) OVER() source_count FROM (
   SELECT 'EXACT_DISPOSAL_SOURCE'::text status,b.source_document_id,b.source_payload_hash,b.source_document_version,b.source_link_id,b.binding_id disposal_binding_id,NULL::uuid acquisition_binding_id
   ...
   UNION ALL
   SELECT 'EXACT_ACQUISITION_SOURCE',b.source_document_id,b.source_payload_hash,b.source_document_version,b.source_link_id,NULL::uuid,b.binding_id
