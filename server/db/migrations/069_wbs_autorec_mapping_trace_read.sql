...
-- A review candidate can only name a mapping the kernel actually read.  The
-- original read exposed identity but not the immutable snapshot/effective
-- window required by the receipt-bound AutoRec proposal verifier.
