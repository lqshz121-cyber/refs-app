...
-- A provider-backed review proposal may use only an approved immutable REFS
-- matching-policy snapshot.  The policy is configuration evidence, never a
-- WBS command, and this reader has no allocation or posting side effect.
