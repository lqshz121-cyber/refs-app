...
BEGIN
  ...
  LEFT JOIN public.wbs_operator_signed_source_link signed
    ON signed.tenant_id=e.tenant_id AND signed.entity_id=e.entity_id
    AND signed.wbs_operator_payable_evidence_row_id=e.wbs_operator_payable_evidence_row_id
  WHERE a.tenant_id=p_tenant AND a.entity_id=p_entity
    AND a.wbs_operator_payable_attestation_id=p_attestation
