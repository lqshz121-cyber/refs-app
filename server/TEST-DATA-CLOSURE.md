...
| --- | --- |
| `npm run test:postgres:fixture:controlled-ap-close` | AP Bill Draft through four-role Post, GL, trial balance, AP aging, and tenant isolation. |
...
| `npm run test:postgres:fixture:signed-wbs-payable-post` | Provider-signed Payable admission through Review, Draft, four-role Post, and reports. |
| `npm run test:postgres:fixture:bank-reconcile` | Reconciled bank payment through posted journal, GL, trial balance, and report rows. |
