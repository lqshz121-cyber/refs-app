...
| 12 golden scenarios | [`contracts/wbs-autorec-golden-scenarios-v1.json`](contracts/wbs-autorec-golden-scenarios-v1.json) fixes exact, partial, one-to-many, many-to-one, cross-company, tolerance, duplicate, reopen boundary, NUL isolation, invalid date, 291001 trace and report-as-source block with expected controls and forward/reverse trace | LOCAL_TESTED | De-identified provider sample set and source-vs-target control-total comparison |
