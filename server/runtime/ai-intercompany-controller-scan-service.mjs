...
export function createAiIntercompanyControllerScanService({pairReader,reconciliationReader,detector}={}){
  if(typeof pairReader!=='function'||typeof reconciliationReader!=='function'||typeof detector!=='function')throw new TypeError('Intercompany Controller scan requires authoritative pair, reconciliation, and detection boundaries.');
