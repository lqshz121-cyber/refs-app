...
export function detectManualJournalRisks(journals,{policy,currentAccountingPeriodId}={}){
  ...
  for(const journal of journals){
    ...
    const noSupport=journal.attachment_count===0&&journal.source_document_ids.length===0;
