...
// Execution intents bind a review allocation to a signed reservation receipt.
// Keep that binding on integer ten-thousandths; Number equality is not a
// valid accounting control even when the displayed values happen to match.
const amountUnits=value=>{
  const candidate=typeof value==='number'&&Number.isFinite(value)?String(value):text(value);
