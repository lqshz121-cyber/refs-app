...
const safeCodes=new Set(['MIGRATION_MANIFEST_MISMATCH','MIGRATION_CHECKSUM_MISMATCH','MIGRATION_IDENTITY_REJECTED','MIGRATION_DATABASE_REJECTED','DB_DOWN_FORBIDDEN','PG_DRIVER_UNAVAILABLE','MIGRATION_TIMEOUT_INVALID','MIGRATION_COMMAND_INVALID','MIGRATION_URL_REQUIRED','MIGRATION_RESET_BLOCKED']);
