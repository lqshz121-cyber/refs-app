...
export function createWbsMcpInboundService({client,persistedSourceReader=null}={}){
  ...
  return Object.freeze({
    ...
    async pullTransactionSnapshot({companyKey,argsByTool,snapshotId,dictionaryVersion,environment='SANDBOX',delivery=null,detachedSignature=null,bankDirectionConventions=null,payableDirectionConventions=null}={}){
      ...
      try{
        const snapshot=buildWbsMcpReadonlySnapshot({envelopes,snapshotId,dictionaryVersion,environment,delivery,detachedSignature,bankDirectionConventions,payableDirectionConventions});
