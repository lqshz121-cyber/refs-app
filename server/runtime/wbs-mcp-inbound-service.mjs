...
export function createWbsMcpInboundService({client,persistedSourceReader=null,traceReceiptVerifier=null}={}){
  ...
  return Object.freeze({
    ...
    async pullTransactionSnapshot({companyKey,argsByTool,snapshotId,dictionaryVersion,environment='SANDBOX',delivery=null,detachedSignature=null,bankDirectionConventions=null,payableDirectionConventions=null,autoRecDetailDirectionConventions=null}={}){
