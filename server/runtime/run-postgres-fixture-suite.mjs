...
export const FIXTURES=Object.freeze([
  ...
  Object.freeze({id:'signed-wbs-bank-reconciliation-close',pattern:'signed admitted WBS bank statement atomically creates exact bank sources with replay and conflict guards'}),
