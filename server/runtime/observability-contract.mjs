...
export const EVENT_CATALOG=Object.freeze([
  ...
  {event:'process_unhandled_rejection',level:'error',fields:['code'],alert:'any occurrence -> a background promise failed without a handler; the process stops cleanly and restarts; investigate the code'},
  {event:'process_uncaught_exception',level:'error',fields:['code'],alert:'any occurrence -> page; process restarts'},
