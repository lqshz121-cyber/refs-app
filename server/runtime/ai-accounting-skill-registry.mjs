...
export const AI_ACCOUNTING_SKILLS=Object.freeze([
  ...
  skill({id:'ACCRUAL_ACCOUNTING',name:'Accrual Accounting',status:'PLANNED_SOURCE_CONTRACT',findingCategory:null,requiredEvidence:['service_period','source_document_or_transaction','entity','period'],allowedOutputs:['future_accrual_review_action']}),
