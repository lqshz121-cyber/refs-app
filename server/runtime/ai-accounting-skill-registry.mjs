...
export const AI_ACCOUNTING_SKILLS=Object.freeze([
  ...
  skill({id:'ACCRUAL_ACCOUNTING',name:'Accrual Accounting',status:'PLANNED_SOURCE_CONTRACT',findingCategory:null,requiredEvidence:['service_period_start','service_period_end','recurring_obligation_id','service_frequency','obligation_status','source_document_id','entity_id','accounting_period_id'],allowedOutputs:['future_accrual_review_action']}),
