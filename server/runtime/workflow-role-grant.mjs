...
export const AUTHORITATIVE_WORKFLOW_ROLES=Object.freeze({
  ...
  UNIT_TRANSFER_MAKER:role('DRAFT',[...READ,'REAL_ESTATE.UNIT_TRANSFER.VIEW','REAL_ESTATE.UNIT_TRANSFER.CREATE','GL.JE.CREATE']),
  UNIT_TRANSFER_SUBMITTER:role('SUBMIT',[...READ,'REAL_ESTATE.UNIT_TRANSFER.VIEW','REAL_ESTATE.UNIT_TRANSFER.SUBMIT','GL.JE.SUBMIT']),
  UNIT_TRANSFER_REVIEWER:role('REVIEW',[...READ,'REAL_ESTATE.UNIT_TRANSFER.VIEW','REAL_ESTATE.UNIT_TRANSFER.REVIEW','GL.JE.REVIEW']),
  UNIT_TRANSFER_APPROVER:role('APPROVE',[...READ,'REAL_ESTATE.UNIT_TRANSFER.VIEW','REAL_ESTATE.UNIT_TRANSFER.APPROVE','GL.JE.APPROVE']),
  UNIT_TRANSFER_POSTER:role('POST',[...READ,'REAL_ESTATE.UNIT_TRANSFER.VIEW','REAL_ESTATE.UNIT_TRANSFER.POST','GL.JE.POST']),
  CASH_TRANSFER_MAKER:role('DRAFT',[...READ,'CASH.TRANSFER.VIEW','CASH.TRANSFER.CREATE','GL.JE.CREATE']),
  CASH_TRANSFER_SUBMITTER:role('SUBMIT',[...READ,'CASH.TRANSFER.VIEW','CASH.TRANSFER.SUBMIT','GL.JE.SUBMIT']),
  CASH_TRANSFER_REVIEWER:role('REVIEW',[...READ,'CASH.TRANSFER.VIEW','CASH.TRANSFER.REVIEW','GL.JE.REVIEW']),
  CASH_TRANSFER_APPROVER:role('APPROVE',[...READ,'CASH.TRANSFER.VIEW','CASH.TRANSFER.APPROVE','GL.JE.APPROVE']),
  CASH_TRANSFER_POSTER:role('POST',[...READ,'CASH.TRANSFER.VIEW','CASH.TRANSFER.POST','GL.JE.POST']),
  CASH_TRANSFER_RECONCILER:role('RECONCILE',[...READ,'CASH.TRANSFER.VIEW','CASH.TRANSFER.RECONCILE']),
  ...
  AP_EXPENSE_MAKER:role('DRAFT',[...READ,'AP.EXPENSE.CREATE']),
