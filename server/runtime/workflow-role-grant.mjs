...
export const AUTHORITATIVE_WORKFLOW_ROLES=Object.freeze({
  ...
  AI_CONTROLLER_REVIEWER:Object.freeze([...READ,'AI.ANALYSIS.EXPLAIN','AI.AMORTIZATION.VIEW','AI.ACCOUNTING.SETTINGS.VIEW']),
  AI_AMORTIZATION_PREPARER:Object.freeze([...READ,'AI.AMORTIZATION.VIEW','AI.AMORTIZATION.PROPOSE','AI.ACCOUNTING.SETTINGS.VIEW']),
