...
export function accountingServerConfig(env=process.env){
  ...
  return {database,issuer,audience,jwksUri,host:env.REFS_HTTP_HOST||'127.0.0.1',port:integer(env.PORT||8080,'PORT',{min:1,max:65535}),maxBodyBytes:integer(env.REFS_HTTP_MAX_BODY_BYTES||1048576,'REFS_HTTP_MAX_BODY_BYTES',{min:1024,max:10*1024*1024}),allowedOrigins:allowedOrigins(env.REFS_HTTP_ALLOWED_ORIGINS||'',env.NODE_ENV==='production'),
