...
export const INTERNAL_TEST_WORKFLOW_GRANT_BUNDLES=Object.freeze({
  ...
  submitter:Object.freeze([...READ,'GL.JE.SUBMIT','CASH.TRANSFER.VIEW','CASH.TRANSFER.SUBMIT','REPORT.FORECAST.VIEW','REPORT.FORECAST.SUBMIT','RECURRING.SCHEDULE.VIEW','RECURRING.SCHEDULE.SUBMIT']),
  reviewer:Object.freeze([...READ,'GL.JE.REVIEW','BANK.RECONCILIATION.REVIEW','BANK.MATCH.REVIEW','CASH.TRANSFER.VIEW','CASH.TRANSFER.REVIEW','RECURRING.SCHEDULE.VIEW','RECURRING.SCHEDULE.MANAGE','REPORT.SAVED_VIEW.SHARE']),
  approver:Object.freeze([...READ,'GL.JE.APPROVE','BANK.RECONCILIATION.SIGN_OFF','CASH.TRANSFER.VIEW','CASH.TRANSFER.APPROVE','CASH.TRANSFER.CONFIGURE.APPROVE','REPORT.FORECAST.VIEW','REPORT.FORECAST.APPROVE','RECURRING.SCHEDULE.VIEW','RECURRING.SCHEDULE.APPROVE']),
  ...
  recurringRunner:Object.freeze([...READ,'RECURRING.SCHEDULE.VIEW','RECURRING.SCHEDULE.RUN'])
});
