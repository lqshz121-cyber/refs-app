...
export const INTERNAL_TEST_WORKFLOW_GRANT_BUNDLES=Object.freeze({
  ...
  submitter:Object.freeze([...READ,'GL.JE.SUBMIT','CASH.TRANSFER.VIEW','CASH.TRANSFER.SUBMIT','REPORT.FORECAST.VIEW','REPORT.FORECAST.SUBMIT','RECURRING.SCHEDULE.SUBMIT']),
  ...
  approver:Object.freeze([...READ,'GL.JE.APPROVE','BANK.RECONCILIATION.SIGN_OFF','CASH.TRANSFER.VIEW','CASH.TRANSFER.APPROVE','CASH.TRANSFER.CONFIGURE.APPROVE','REPORT.FORECAST.VIEW','REPORT.FORECAST.APPROVE','RECURRING.SCHEDULE.APPROVE']),
