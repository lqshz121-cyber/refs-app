...
const REQUIRED=Object.freeze(['readPersistedWbsInboundRows','readPersistedWbsControlRows','readApprovedWbsAutoRecMappings','readApprovedWbsAutoRecMatchingPolicies','readWbsAutoRecObservedStateEvidence']);
