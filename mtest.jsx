...
if(!authoritativeRuntimeConfigured(configuredEnvironment)||!configuredRuntimeMarkup.includes('REFS accounting')||configuredRuntimeMarkup.includes('Authoritative API required')||configuredRuntimeMarkup.includes('Ricky (Controller)')){failed++;console.error('FAIL fully configured authoritative runtime is unreachable');}else console.log('PASS fully configured authoritative runtime bypasses the demo and lock screen');
