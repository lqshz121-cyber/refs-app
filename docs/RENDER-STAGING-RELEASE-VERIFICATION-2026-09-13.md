...
- Git ref: `main`
- Required source commit: `0f596cd8ad4568a6dba711bf52c89098e440f9d9`
...
2. Its `release` is either the full `0f596cd8ad4568a6dba711bf52c89098e440f9d9` or an exact Git prefix of it.
3. The static release's `https://refs-app.onrender.com/refs-build.js` must carry the same exact release as the API. If it differs, deploy both the static client and API from the required source commit before user acceptance.
