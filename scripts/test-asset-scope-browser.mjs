...
export async function readAuthoritativeDisposalOptions(){throw new Error('Unexpected disposal read');}
export async function createAuthoritativeAssetDisposal(){throw new Error('Unexpected disposal mutation');}
