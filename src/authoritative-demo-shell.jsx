...
export function AuthoritativeDemoTopbar({
  ...
  return <header className="topbar authoritative-topbar authoritative-demo-topbar">
    ...
    <button type="button" className="cmdk" disabled aria-disabled="true" title="Search is unavailable until an authorised server-backed discovery contract exists">Search or jump</button>
    <div className="top-right authoritative-top-actions">
      ...
      <button type="button" className="icon-btn" aria-label="Refresh authoritative accounting evidence" title="Refresh authoritative accounting evidence" onClick={onRefresh}>Refresh</button>
