...
export function AuthoritativeTopbar({
  ...
  return <header className="topbar authoritative-topbar">
    ...
    <div className="top-right authoritative-top-actions">
      <span className="period-chip authoritative-period-chip"><span className="period-label">Period</span><b>{periodLabel}</b><span className="badge badge-ok">Current data</span></span>
