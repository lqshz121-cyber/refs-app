...
export const DEFAULT_SETTING = (en) => ({
  ...
  account_setting: [
    ...
    {category:'Bank Transaction', type:'Dividend', detail:'Actual dividend amount', account:'291000', desc:'Due to/from 业主', project:'Select', status:'LIVE'},
    {category:'Bank Transaction', type:'Dividend', detail:'Deduction amount', account:'220204', desc:'Tax Payable', project:'', status:'LIVE'},
    {category:'Bank Transaction', type:'Internal Transfer', detail:'Normal', account:'111000', desc:'对方银行账户', project:'', status:'LIVE'},
  ...
  cost_setting: [
    ...
    {category:'Cost General Ledger', type:'Direct(Debit)', detail:'per cost code', account:'164400', desc:'CWIP (在建)', status:'LIVE'},
    {category:'Cost General Ledger', type:'Direct(Debit)·COMPLETED', detail:'per cost code', account:'510000', desc:'COGS (完工)', status:'LIVE'},
  ...
  payable_setting: [
    {category:'Payable', type:'Credit', detail:'(all)', account:'291001', desc:'Due to/from_按Payee', entity:'', status:'LIVE'},
  ...
  batch_setting: [
    {memo:'月度利息计提', dr:'164500', cr:'220410', sequential:true, reverse_next_month:false, status:'LIVE'},
    {memo:'月末应计费用', dr:'688000', cr:'220300', sequential:true, reverse_next_month:true, status:'LIVE'},
  ],
});
