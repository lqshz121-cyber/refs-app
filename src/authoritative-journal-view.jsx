...
export function AuthoritativeJournalView({children}) {
  return <section className="full-bleed authoritative-journal-workspace authoritative-workbench-shell authoritative-journal-presentation" aria-label="Authoritative journal entries">
