...
export function AuthoritativeAiAuditWorkspace({config,fetcher=globalThis.fetch}){
  ...
  return <AuthoritativeWorkspaceView area="AI Audit Center">
    <AuthoritativeWorkspaceHeader eyebrow="AUTHORITATIVE - AI ACCOUNTING" title="AI Audit Center" description="Server-materialized WBS exception findings with immutable source hashes. This workspace is evidence only: it cannot create a Draft JE, review, approve, post, or write WBS." status="READ ONLY"/>
