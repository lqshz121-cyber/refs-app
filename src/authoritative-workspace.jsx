...
export function AuthoritativeDocumentWorkspace({kind,documents=[],adjustments=[],view,onViewChange,onOpenDocument,onOpenAdjustment}) {
  ...
  return <div className="authoritative-document-workspace">
    ...
    <AuthoritativeDocumentTable title={bill?'AP bills':'AR invoices'} documents={page.rows} kind={kind} onOpen={onOpenDocument}/>
    ...
    <AuthoritativeAdjustmentSummary title={bill?'AP adjustments':'AR adjustments'} adjustments={filteredAdjustments} onOpen={onOpenAdjustment}/>
  </div>;
}
