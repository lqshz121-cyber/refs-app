...
export function AuthoritativeDocumentDetail({document,kind,entityId,config,returnContext,onBack,currentActorAccess,accounts=[],fetcher=globalThis.fetch,onOpenDraft,onRefresh}){
