...
const ICON_PATHS = {
  ...
  chevronDown:['M6.5 9.5l5.5 5 5.5-5'],
  chevronRight:['M9.5 6.5l5 5.5-5 5.5'],
  sun:        ['M12 7.2a4.8 4.8 0 1 0 0 9.6 4.8 4.8 0 0 0 0-9.6z', 'M12 2.8v2M12 19.2v2M2.8 12h2M19.2 12h2M5.5 5.5l1.4 1.4M17.1 17.1l1.4 1.4M18.5 5.5l-1.4 1.4M6.9 17.1l-1.4 1.4'],
  moon:       ['M19.7 14.7A7.8 7.8 0 0 1 9.3 4.3 8.2 8.2 0 1 0 19.7 14.7z'],
};
