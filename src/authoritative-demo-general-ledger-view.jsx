...
export function AuthoritativeDemoGeneralLedgerView({eyebrow,title,subtitle,actions,children}){
  return <section className="full-bleed authoritative-general-ledger authoritative-workbench-shell demo-general-ledger-presentation" aria-label="Authoritative General Ledger">
...
export function AuthoritativeDemoGeneralLedgerDetailView({eyebrow,title,subtitle,children}){
  return <section className="full-bleed authoritative-general-ledger-detail authoritative-workbench-shell authoritative-evidence-page demo-general-ledger-detail-presentation" aria-label="Authoritative General Ledger line detail">
