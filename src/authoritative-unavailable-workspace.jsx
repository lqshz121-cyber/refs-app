...
export function AuthoritativeUnavailableWorkspace({ item, config }) {
  ...
  return <AuthoritativeDemoView area={`${label} unavailable workspace`} className="stack authoritative-unavailable-workspace">
    <AuthoritativeDemoWorkspaceHeader eyebrow="WORKSPACE" title={`${label} is coming soon`} description="We're preparing this workspace so your finance team can work from clear, connected financial information." status="COMING SOON"/>
