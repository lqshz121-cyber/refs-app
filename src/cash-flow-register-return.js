...
export function localCashFlowRegisterTarget({ entityId = '', accountCodes = [], scope = '', fromP = '', toP = '', propertyId = 'ALL', projectId = 'ALL', loanId = 'ALL', dimensionState = '' } = {}) {
  ...
  return {
    ...
    reportReturn:localReportReturnContext({tab:'Cash Flow',fromP,toP,entityId,propertyId,projectId,loanId,cashScope,drillAccounts:[accountCode],drillLabel:`Cash flow · ${cashScope}`}),
  };
}
