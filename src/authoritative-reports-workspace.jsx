...
const REPORT_ICON_NAMES=Object.freeze({
  TRIAL_BALANCE:'lines',DETAIL_1099:'document',ACCOUNTS_RECEIVABLE_AGING_DETAIL:'calendar',ACCOUNTS_RECEIVABLE_AGING_SUMMARY:'calendar',ACCOUNTS_PAYABLE_AGING_DETAIL:'calendar',ACCOUNTS_PAYABLE_AGING_SUMMARY:'calendar',ACCOUNT_LIST:'book',ADJUSTED_TRIAL_BALANCE:'lines',BALANCE_SHEET:'book',BALANCE_SHEET_COMPARISON:'book',BALANCE_SHEET_DETAIL:'book',BALANCE_SHEET_SUMMARY:'book',COLLECTIONS_REPORT:'wallet',CUSTOMER_BALANCE_DETAIL:'wallet',CUSTOMER_BALANCE_SUMMARY:'wallet',DEPOSIT_DETAIL:'bank',INCOME_STATEMENT:'bars',INVOICE_LIST:'wallet',INVOICES_AND_RECEIVED_PAYMENTS:'wallet',JOURNAL_REPORT:'book',PROFIT_AND_LOSS_BY_CLASS:'bars',PROFIT_AND_LOSS_BY_TAG_GROUP:'bars',PROFIT_AND_LOSS_BY_CUSTOMER:'bars',PROFIT_AND_LOSS_PERCENT_TOTAL_INCOME:'bars',PROFIT_AND_LOSS_COMPARISON:'bars',PROFIT_AND_LOSS_DETAIL:'bars',QUARTERLY_PROFIT_AND_LOSS_SUMMARY:'bars',RECENT_TRANSACTIONS:'book',EXPENSES_BY_VENDOR_SUMMARY:'wallet',INVALID_JOURNAL_TRANSACTIONS:'book',OPEN_INVOICES:'wallet',STATEMENT_LIST:'document',TERMS_LIST:'document',UNPAID_BILLS:'wallet',TRANSACTION_DETAIL_BY_ACCOUNT:'book',TRANSACTION_DRILLDOWN_REPORT:'book',TRANSACTION_LIST_BY_CUSTOMER:'wallet',TRANSACTION_LIST_BY_DATE:'book',TRANSACTION_LIST_BY_TAG_GROUP:'book',TRANSACTION_LIST_WITH_SPLITS:'book',TRANSACTION_LIST_BY_VENDOR:'wallet',VENDOR_CONTACT_LIST:'wallet',VENDOR_BALANCE_DETAIL:'wallet',VENDOR_BALANCE_SUMMARY:'wallet',CASH_FLOW:'exchange',STATEMENT_OF_CASH_FLOWS:'exchange',GENERAL_LEDGER:'book',GENERAL_LEDGER_LIST:'book',
