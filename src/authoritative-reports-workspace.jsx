...
export const AuthoritativeFullStatementReport=({report,rows,returnContext,onBack,onRefresh,onOpenEvidence,loading=false,tableRef})=>{
  ...
  return <section className="full-bleed qbo-transaction-report authoritative-evidence-page authoritative-full-statement" aria-label={`${title} full report`}>
    ...
    <header className="accounting-page-head"><div><div className="page-eyebrow">FINANCIAL REPORT</div><h1 className="page-h">{title}</h1><p className="page-subtitle">Review posted balances.</p></div><div className="report-period-chip"><span>Report scope</span><b><ScopeLabel context={returnContext}/></b><small>READ ONLY</small></div></header>
