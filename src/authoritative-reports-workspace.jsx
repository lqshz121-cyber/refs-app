...
export function AuthoritativeReportsWorkspace({config,fetcher=globalThis.fetch,environment=globalThis,initialCatalog=DEFAULT_AUTHORITATIVE_REPORTS_CATALOG,onOpenArAging=()=>{},onOpenGeneralLedger=()=>{},onOpenReconciliation=()=>{},workspaceTitle='Standard reports',workspaceEyebrow='',workspaceDescription='',initialDimensionType='PROPERTY',initialDimensionRef=''}){
