...
export function AuthoritativeReportsWorkspace({config,fetcher=globalThis.fetch,environment=globalThis,initialCatalog=DEFAULT_AUTHORITATIVE_REPORTS_CATALOG,onOpenArAging=()=>{},onOpenGeneralLedger=()=>{},workspaceTitle='Reports center',workspaceEyebrow='REPORTING',workspaceDescription='Review posted financial reports.',initialDimensionType='PROPERTY',initialDimensionRef=''}){
