...
export function localBalanceSheetRegisterTarget({ entityId = '', accountCode = '', accountName = '', fromP = '', toP = '', propertyId = 'ALL', projectId = 'ALL', loanId = 'ALL', dimensionState = '', reportCenterReturn = null } = {}) {
  ...
  return {
    ...
    reportReturn:localReportReturnContext({tab:'Balance Sheet',fromP,toP,entityId,propertyId,projectId,loanId,cashScope,drillAccounts:[code],drillLabel:`${code} ${accountName}`.trim(),reportCenterReturn}),
  };
}
