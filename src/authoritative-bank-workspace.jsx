...
export function AuthoritativeReconciliationDetail({row,scope,onBack,config,fetcher,onChanged=()=>{}}){
  ...
  const hasAuthorizedWorksheetEvidence=worksheet.rows.length>0;
  ...
  {hasAuthorizedWorksheetEvidence&&<section className="card" aria-label="Reconciliation lifecycle command">
