// Frozen pre-Phase-2 demonstration shell. It is intentionally not imported by
// the production entry point. Keep it only while its accounting calculations
// are migrated behind authoritative API contracts in later roadmap phases.
