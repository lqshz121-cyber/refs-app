...
export const DEFAULT_EXPENSE_COLUMNS = { DATE:true, TYPE:true, NUMBER:true, PAYEE:true, CATEGORY:true, DUE_DATE:false, TOTAL:true, BILL_APPROVAL:true, LOCAL_PROOF:true };
