...
export function AuthoritativeDemoReportsView({eyebrow,title,description,scope,children,className=''}) {
  return <section className={`reports-library authoritative-reports-library authoritative-workbench-shell demo-reports-presentation ${className}`.trim()} aria-label={`${title} workspace`}>
