...
export function AuthoritativeGeneralLedgerWorkspace({config,fetcher=globalThis.fetch,environment=globalThis,onBack=null}){
  ...
  return <AuthoritativeGeneralLedgerView eyebrow="ACCOUNTING" title="General Ledger" periodCaption={authoritativeGeneralLedgerPeriodCaption(rows)} subtitle="Review posted ledger activity.">
    {onBack&&<div className="qbo-report-back authoritative-gl-catalog-back"><button type="button" className="btn btn-sm btn-ghost" onClick={onBack}>Back to standard reports</button></div>}
