...
export function AuthoritativeGeneralLedgerWorkspace({config,fetcher=globalThis.fetch,environment=globalThis,onBack=null,backLabel='Back to standard reports',initialAccountCode=''}){
