  ...
  return <div className="app authoritative-app">
    ...
    <div className="main">
      ...
      <main className="content">
        ...
        {phase === 'READY' && route === 'overview' && <AuthoritativeOverview counts={counts} onNavigate={setRoute} scope={{entityId:config.entityId,periodId:config.periodId}} config={config} fetcher={boundFetcher}/>}
        ...
        {phase === 'READY' && !['overview','payables','receivables','bank','reconciliation','wbs-autorec-evidence','reports','project-cost-cwip','construction-loan','amortization','intercompany','consolidation','journals','source-documents','chart-of-accounts','account-inquiry','general-ledger'].includes(route) && <AuthoritativeUnavailableWorkspace item={navigationItemForRoute(route)} config={config}/>}
      </main>
    </div>
  </div>;
}
