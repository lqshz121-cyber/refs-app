    ...
    <div className="main">
      ...
      <main className="content">
        <section className="authoritative-scope-bar" aria-label="Authoritative accounting scope">
          <span title={`${scopePresentation.entityHint ? `${scopePresentation.entityHint} ` : ''}Company ID: ${scopePresentation.entityDetail}`}><b>Company</b> {scopePresentation.entityLabel}{scopePresentation.entityHint&&<small className="muted sm"> — name pending confirmation</small>}</span>
          <span title={`${scopePresentation.periodHint ? `${scopePresentation.periodHint} ` : ''}${scopePresentation.periodDetail}`}><b>Reporting period</b> {scopePresentation.periodLabel}{scopePresentation.periodHint&&<small className="muted sm"> — details pending confirmation</small>}</span>
