  ...
  return <div className="app authoritative-app">
    ...
    <div className="main">
      ...
      <main className="content">
        ...
        {phase === 'READY' && route === 'property-ops-pickup' && <AuthoritativePropertyRentWorkspace key={`property-ops-pickup-${workspaceRefreshVersion}`} config={config} fetcher={boundFetcher} environment={environment} propertyPnlTitle="Property operating P&amp;L" onBack={()=>setRoute('overview')}/>}
        ...
        {phase === 'READY' && route === 'amortization' && <AuthoritativeAmortizationWorkspace key={`amortization-${workspaceRefreshVersion}`} config={config} fetcher={boundFetcher} onBack={()=>setRoute('overview')}/>}
