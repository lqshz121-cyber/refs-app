...
const AI_ACCRUAL_ANALYSIS_FIELDS=['status','entity_id','accounting_period_id','candidates','can_create_draft','can_review','can_approve','can_post'];
