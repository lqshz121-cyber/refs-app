...
import {AuthoritativeFullStatementReport,AuthoritativeReportDetail,AuthoritativeReportsWorkspace,AuthoritativeStatementOfCashFlowsReport,DimensionProfitabilitySummary,FinancialStatementSummary,DEFAULT_AUTHORITATIVE_REPORTS_CATALOG,authoritativeReportLineageConfig,authoritativeReportPeriodCaption,authoritativeReportRangeCaption,findAuthoritativeGeneralLedgerShortcut,findAuthoritativeMappingBackedReportShortcuts,findAuthoritativePropertyReportShortcuts,findAuthoritativeReportShortcuts,normalizeAuthoritativeReportsCatalog,restoreAuthoritativeReportTablePosition} from '../src/authoritative-reports-workspace.jsx';
...
async function main(){
  ...
  assert.match(generalLedgerSearchMarkup,/1 match/);assert.match(generalLedgerSearchMarkup,/Matching ledger reports/);assert.match(generalLedgerSearchMarkup,/General Ledger/);assert.doesNotMatch(generalLedgerSearchMarkup,/No reports found/,'the observed General Ledger report must not fall through to an empty finder result');
