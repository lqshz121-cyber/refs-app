...
async function main(){
  ...
  assert.match(markup,/FINANCIAL[\s\S]*REPORTING/);assert.match(markup,/Reports center/);assert.match(markup,/Reporting scope/);assert.match(markup,/POSTED ledger evidence/);assert.match(markup,/Core statements/);assert.match(markup,/Cash &amp; capital/);assert.match(markup,/Property &amp; project analysis/);assert.match(markup,/Group &amp; comparison/);assert.match(markup,/Find a report/);assert.match(markup,/Core statement shortcuts/);assert.match(markup,/Trial Balance/);assert.match(markup,/Balance Sheet/);assert.match(markup,/Income Statement/);assert.match(markup,/Cash movement evidence/);assert.doesNotMatch(markup,/>Cash Flow</);assert.match(markup,/Review posted ledger evidence for the selected company and period/);assert.match(markup,/VIEW ONLY/);assert.match(markup,/rep-grid/);assert.match(markup,/rep-card/);assert.match(markup,/report-workbench/);
  assert.match(markup,/authoritative-workbench-shell/);assert.match(markup,/Reports workspace structure/);assert.match(markup,/Review/);
  ...
  assert.match(capitalMarkup,/Construction Loan/);assert.match(capitalMarkup,/Statement of cash flows/);assert.match(capitalMarkup,/CWIP rollforward/);assert.match(capitalMarkup,/Construction loan rollforward/);assert.match(capitalMarkup,/Prepaid rollforward/);
