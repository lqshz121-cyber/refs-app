...
for(const token of ['AI JE Workbench','HUMAN-CONTROLLED AI DRAFT','DRAFT ONLY','MANUAL DRAFT ONLY','NO SUBMIT','NO REVIEW','NO APPROVE','NO POST','WBS Payable journal proposals','HUMAN DECISION ONLY','Accounting decision queue','PERSISTED EVIDENCE','HUMAN ACCEPT OR REJECT','Refreshing'])assert.match(markup,new RegExp(token,'i'));
