...
for(const token of ['refreshAuthoritativeAiAccountingDecisionQueue','decideAuthoritativeAiAccountingDecision','createAuthoritativeAiAccountingDecisionDraft','aiAccountingDecisionCommandIdempotencyKey','retainAuthoritativeAiAccountingPostedOutcomeReview','aiAccountingPostedOutcomeIdempotencyKey','server-derived Posted review','browser cannot supply or change accounting evidence','No cached, local, or demonstration decision is substituted','standard Journal submit, review, approve, and post remain outside'])assert.match(decisionSource,new RegExp(token,'i'));
