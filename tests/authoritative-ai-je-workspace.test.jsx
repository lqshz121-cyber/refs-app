...
for(const token of ['refreshAuthoritativeAiAccountingDecisionQueue','decideAuthoritativeAiAccountingDecision','createAuthoritativeAiAccountingDecisionDraft','aiAccountingDecisionCommandIdempotencyKey','No cached, local, or demonstration decision is substituted','standard Journal submit, review, approve, and post remain outside'])assert.match(decisionSource,new RegExp(token,'i'));
