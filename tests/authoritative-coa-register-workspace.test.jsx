...
assert.match(source,/AuthoritativeChartOfAccountsView/);assert.match(source,/AuthoritativeAccountRegisterView/);assert.match(source,/Chart of Accounts reading path/);assert.match(source,/Account register reading path/);
