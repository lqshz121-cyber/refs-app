...
assert.match(styles,/\.authoritative-register-table,\.authoritative-coa-table,\.authoritative-journal-table\{max-height:60vh;overflow:auto;overscroll-behavior:contain;\}/,'long accounting tables must remain contained on mobile after the generic table override');
