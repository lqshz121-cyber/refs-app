...
assert.match(styles,/@media \(max-width:1024px\)\{[\s\S]*?\.authoritative-register-scope\{display:flex;gap:8px;overflow-x:auto;[\s\S]*?\.authoritative-register-scope>span\{flex:0 0 170px;min-height:0;/,'tablet and high-zoom Register scope must use one compact, keyboard-scrollable fact strip');
