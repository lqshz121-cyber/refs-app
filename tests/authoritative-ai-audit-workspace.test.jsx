...
for(const token of ['explainAuthoritativeAiAccountingAnalysis','recordAuthoritativeAiAmortizationCoverageEvidence','refreshAuthoritativeAiAccountingAnalysisSummary','refreshAuthoritativeAiWbsExceptionFindings','refreshAuthoritativeAiPrepaidCoverageFindings','refreshAuthoritativeAiDuplicatePayableFindings','refreshAuthoritativeAiUnmatchedBankPaymentFindings','refreshAuthoritativeAiCostDimensionFindings','refreshAuthoritativeAiLoanReferenceFindings','refreshAuthoritativeAiAmortizationSchedules','No substitute, browser-stored, or demonstration evidence','Controller analysis summary','AI controller explanation','Generate explanation','Prepaid coverage gaps','Retain coverage evidence','No amortization proposal or journal action was created','Exact duplicate payable risk','Unmatched bank payment risk','Construction cost dimension risk','Construction loan reference risk','Prepaid / amortization proposals','Draft / review / approve / post: disabled','Due date requires human assignment'])assert.match(source,new RegExp(token,'i'));
