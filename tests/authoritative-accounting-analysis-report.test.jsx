...
for(const token of ['refreshAuthoritativeAiAccountingAnalysisReports','refreshAuthoritativeAiAccountingAnalysisSummary','refreshAuthoritativeAiFindingActions','refreshAuthoritativeAiInvoiceAccountingClassifications','retainAuthoritativeAiInvoiceAccountingClassifications','Retain classification evidence','Audit and outbox records were committed atomically','source_payload_hash','Capitalization is never inferred','request_hash','finding_ids','finding_hash','No browser, cached, or demonstration analysis is substituted','Empty evidence is not treated as a clean close'])assert.match(source,new RegExp(token,'i'));
