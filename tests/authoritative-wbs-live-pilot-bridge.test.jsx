...
import {accountingApiConfig,importAuthoritativeWbsPayablesToTestAccounting,wbsTestImportIdempotencyKey} from '../src/accounting-api.js';
...
assert.match(source,/config\?\.wbsTestImportMode==='ENABLED'&&tool==='list_payables'&&state\.phase==='READY'&&observation\?\.record_count>0/,'test import visibility must require explicit configuration and a successful nonempty Payables observation');
