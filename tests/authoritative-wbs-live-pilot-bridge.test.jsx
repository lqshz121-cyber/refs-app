...
assert.match(fs.readFileSync('src/authoritative-wbs-live-pilot-observation.jsx','utf8'),/companyCode:scopedPayables\?companyCode\.trim\(\)\|\|null:null,dateFrom:scopedPayables\?dateFrom:null,dateTo:scopedPayables\?dateTo:null/,'the browser must send one explicit Provider-native company/date scope for Payables and preserve the existing contract for other tools');
