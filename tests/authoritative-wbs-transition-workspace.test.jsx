...
assert.match(markup,/SOURCE VERIFICATION PENDING/);
assert.match(markup,/NO ENTRIES CREATED/);
assert.match(markup,/aria-label="WBS data safeguards"/);
assert.match(markup,/Refresh WBS data/);
...
assert.match(livePilotSource,/row\[field\]===null\?'Not available':row\[field\]/);
