...
assert.match(markup,/VIEW DATA/);
assert.match(markup,/REVIEW NEEDED/);
assert.match(markup,/NO POSTING FROM THIS PAGE/);
assert.match(markup,/aria-label="WBS workspace safeguards"/);
assert.match(markup,/Refresh WBS information/);
...
assert.match(markup,/No WBS information loaded yet/);
assert.match(markup,/This page is for review only and never creates or posts accounting entries/);
