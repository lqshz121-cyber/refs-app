...
assert.match(markup,/SIGNATURE NEEDED/);
assert.match(markup,/VIEW ONLY/);
assert.match(markup,/ACCOUNTING REVIEW NEEDED/);
assert.match(markup,/NO JOURNAL CREATED/);
assert.match(markup,/aria-label="WBS record safeguards"/);
assert.match(markup,/Refresh WBS records/);
...
assert.match(markup,/Mixed-company records stay in exception review and cannot create a journal entry/);
...
assert.match(livePilotSource,/row\[field\]===null\?'Not provided':row\[field\]/);
