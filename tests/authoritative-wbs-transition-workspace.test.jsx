...
assert.match(markup,/Load production WBS observation/);
...
assert.match(markup,/No production observation loaded/);
assert.match(markup,/No provider credential or raw business identifier is exposed/);
