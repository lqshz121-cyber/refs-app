...
for(const token of ['Amortization Center','SIGNED SOURCE','INDEPENDENT REVIEW','DRAFT ONLY','STANDARD POST','NO AUTO POST','Back to Overview','Loading amortization readiness','Loading prepaid rollforward'])assert.match(markup,new RegExp(token,'i'));
