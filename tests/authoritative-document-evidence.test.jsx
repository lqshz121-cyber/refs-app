...
assert.match(styles,/@media\s*\(max-width:1100px\)\s*\{\.authoritative-list-filters\{grid-template-columns:repeat\(2,minmax\(0,1fr\)\)/,'AP/AR filters must collapse to two shrinkable columns before a 900px viewport can overflow');
