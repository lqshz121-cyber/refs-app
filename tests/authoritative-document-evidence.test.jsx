...
assert.match(workspaceMarkup,/<summary aria-label="Filter, 5 active filters">Filter<\/summary>/,'Expenses must keep the observed concise QBO Filter label while retaining the active-filter count for assistive technology');
...
assert.match(workspaceMarkup,/<summary aria-label="Filter, 5 active filters">Filter<\/summary><div[^>]*><label>Status <select/,'Expenses Status must stay inside the observed compact Filter disclosure');
