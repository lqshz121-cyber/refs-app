...
assert.doesNotMatch(accountingSettingsUnavailableMarkup,/Transaction posting policy|Asset &amp; expense policy|Bills and expenses|Purchase orders|Search settings|More options|Edit|Required fields|Effective date|threshold|billable|Default bill payment terms|Default email message|ready to post|Save|Pay|Post/,'the unavailable Accounting settings route must not reproduce expense-policy values, purchase/payment controls, edit controls, or posting automation');
