...
assert.match(appSource, /name pending confirmation/,
  'a missing company name must be explained in business language without promoting its internal UUID to primary text');
assert.match(appSource, /details pending confirmation/,
  'a missing reporting-period label must be explained in business language without presenting an internal ID as the period');
