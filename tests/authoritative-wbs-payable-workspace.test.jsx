...
for(const token of ['Review access needed','WBS Payable Reviewer','does not allow importing, creating a draft, approving, or posting','Unsigned pilot records are not included'])assert.match(reviewSource,new RegExp(token.replace(/[.*+?^${}()|[\]\\]/g,'\\$&')),'WBS review denial must give finance users a clear access request while preserving the unsigned boundary');
