...
assert.match(empty,/No posted records yet/);assert.match(empty,/finance should confirm a signed source, complete review, and post/); assert.doesNotMatch(empty,/<table/);
