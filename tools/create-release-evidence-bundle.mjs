...
const scriptCoverage = Object.fromEntries(
  ['test', 'build', 'test:release-harness', 'test:release-simulation', 'verify:external-release-gate', 'verify:authoritative-runtime-evidence', 'verify:release-s3-scanner', 'verify:release-wbs-receipt', 'verify:stage1-payable-live-acceptance', 'verify:stage2-bank-live-chain', 'verify:stage3-wbs-live-chain', 'verify:stage3-cost-cwip-live-chain', 'verify:stage3-g11-live-chain', 'verify:stage3-insurance-prepaid-live-chain', 'verify:stage3-property-rent-live-chain', 'verify:stage3-reporting-live-chain', 'verify:stage4-report-live-chain']
